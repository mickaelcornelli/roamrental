import { View, Text, Dimensions, StyleSheet, Image, Share, TouchableOpacity } from 'react-native'
...
const Page = () => {
    ...
    const showToast = () => {
        Toast.show({
            type: 'success',
            text1: `La ${listing.room_type}, ${listing.smart_location} hébergé par ${listing.host_name}`,
            ...
            >
                ...
                <View style={styles.infoContainer}>
                    ...
                    <Text style={styles.location}>
                        {listing.room_type} à {listing.smart_location}
                    </Text>
                    <Text style={styles.rooms}>
                        {listing.guests_included} invités · {listing.bedrooms} chambres · {listing.beds} lit ·{' '}
                    ...
                    <View style={styles.hostView}>
                        ...
                        <View>
                            <Text style={{ fontWeight: '500', fontSize: 16 }}>Hébergé par {listing.host_name}</Text>
                            <Text>Hôte depuis {listing.host_since}</Text>
                        </View>
                    </View>

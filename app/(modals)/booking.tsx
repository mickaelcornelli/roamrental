      ...
      <View style={styles.card}>
        {openCard != 0 && (
          <AnimatedTouchableOpacity
            ...
            <Text style={styles.previewText}>Ou</Text>
            <Text style={styles.previewdData}>Partout</Text>
          </AnimatedTouchableOpacity>
        )}

        {openCard == 0 && <Text style={styles.cardHeader}>Où allez-vous ?</Text>}
        {openCard == 0 && (
      ...
      <View style={styles.card}>
        {openCard != 1 && (
          <AnimatedTouchableOpacity
            ...
            <Text style={styles.previewdData}>N'importe quelle semaine</Text>
          </AnimatedTouchableOpacity>
        )}

        {openCard == 1 && <Text style={styles.cardHeader}>Quand avez-vous prévu votre voyage ?</Text>}
      ...
      <View style={styles.card}>
        {openCard != 2 && (
          <AnimatedTouchableOpacity
            ...
            <Text style={styles.previewdData}>Ajouter un invité</Text>
          </AnimatedTouchableOpacity>
        )}

        {openCard == 2 && <Text style={styles.cardHeader}>Qui vient ?</Text>}
        ...
        <View
          ...
          <TouchableOpacity
            ...
            <Ionicons
              ...
              color={'#fff'}
            />
            <Text style={defaultStyles.btnText}>Rechercher</Text>
          </TouchableOpacity>
        </View>
      </Animated.View>
    </BlurView>
